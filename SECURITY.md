...
<a name="reporting"></a>
## Reporting security problems in the Flipcash Protobuf API

Please use this [Report a Vulnerability](https://github.com/code-payments/flipcash2-protobuf-api/security/advisories/new) link.
