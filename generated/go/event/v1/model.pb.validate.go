...
func (m *Event) validate(all bool) error {
	...
	case *Event_BlobUpdate:
		...
		if all {
			switch v := interface{}(m.GetBlobUpdate()).(type) {
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, EventValidationError{
						field:  "BlobUpdate",
		...
		} else if v, ok := interface{}(m.GetBlobUpdate()).(interface{ Validate() error }); ok {
			if err := v.Validate(); err != nil {
				return EventValidationError{
					field:  "BlobUpdate",
					reason: "embedded message failed validation",
...
func (m *ChatUpdate) validate(all bool) error {
	...
	if len(m.GetMetadataUpdates()) > 1024 {
		err := ChatUpdateValidationError{
			field:  "MetadataUpdates",
...
// Validate checks the field values on BlobUpdate with the rules defined in the
// proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *BlobUpdate) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on BlobUpdate with the rules defined in
// the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in BlobUpdateMultiError, or
// nil if none found.
func (m *BlobUpdate) ValidateAll() error {
	return m.validate(true)
}

func (m *BlobUpdate) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, BlobUpdateValidationError{
					field:  "Blobs",
					reason: "embedded message failed validation",
					cause:  err,
				})
		...
		if err := v.Validate(); err != nil {
			return BlobUpdateValidationError{
				field:  "Blobs",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return BlobUpdateMultiError(errors)
	}

	return nil
}

// BlobUpdateMultiError is an error wrapping multiple validation errors
// returned by BlobUpdate.ValidateAll() if the designated constraints aren't met.
type BlobUpdateMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m BlobUpdateMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m BlobUpdateMultiError) AllErrors() []error { return m }

// BlobUpdateValidationError is the validation error returned by
// BlobUpdate.Validate if the designated constraints aren't met.
type BlobUpdateValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e BlobUpdateValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e BlobUpdateValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e BlobUpdateValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e BlobUpdateValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e BlobUpdateValidationError) ErrorName() string { return "BlobUpdateValidationError" }

// Error satisfies the builtin error interface
func (e BlobUpdateValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = BlobUpdateValidationError{}
