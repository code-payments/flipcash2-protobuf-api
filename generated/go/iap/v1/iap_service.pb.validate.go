...
func (m *Metadata) validate(all bool) error {
	...
	if l := utf8.RuneCountInString(m.GetProduct()); l < 1 || l > 128 {
	...
	if !_Metadata_Currency_Pattern.MatchString(m.GetCurrency()) {
		err := MetadataValidationError{
			field:  "Currency",
...
var _Metadata_Currency_Pattern = regexp.MustCompile("^[a-z]{3}$")
