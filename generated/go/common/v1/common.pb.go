...
func (Response_Result) EnumDescriptor() ([]byte, []int) {
	return file_common_v1_common_proto_rawDescGZIP(), []int{16, 0}
}
...
type Substitution struct {
	...
	// Types that are assignable to Kind:
	//
	//	*Substitution_PhoneNumberToContactName
	//	*Substitution_UserIdToDisplayName
...
func (x *Substitution) GetPhoneNumberToContactName() *PhoneNumber {
	if x, ok := x.GetKind().(*Substitution_PhoneNumberToContactName); ok {
		return x.PhoneNumberToContactName
	}
	return nil
}

func (x *Substitution) GetUserIdToDisplayName() *UserId {
	if x, ok := x.GetKind().(*Substitution_UserIdToDisplayName); ok {
		return x.UserIdToDisplayName
	}
	return nil
}
...
type Substitution_PhoneNumberToContactName struct {
	// Phone number -> contact name or formatted phone number
	PhoneNumberToContactName *PhoneNumber `protobuf:"bytes,2,opt,name=phone_number_to_contact_name,json=phoneNumberToContactName,proto3,oneof"`
}

type Substitution_UserIdToDisplayName struct {
	// User ID -> display name
	UserIdToDisplayName *UserId `protobuf:"bytes,3,opt,name=user_id_to_display_name,json=userIdToDisplayName,proto3,oneof"`
}

func (*Substitution_PhoneNumberToContactName) isSubstitution_Kind() {}

func (*Substitution_UserIdToDisplayName) isSubstitution_Kind() {}
...
var file_common_v1_common_proto_rawDesc = []byte{
	...
	0x20, 0x18, 0x20, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0xe7, 0x01, 0x0a, 0x04, 0x41,
	0x75, 0x74, 0x68, 0x12, 0x3d, 0x0a, 0x08, 0x6b, 0x65, 0x79, 0x5f, 0x70, 0x61, 0x69, 0x72, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x20, 0x2e, 0x66, 0x6c, 0x69, 0x70, 0x63, 0x61, 0x73, 0x68,
	0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x76, 0x31, 0x2e, 0x41, 0x75, 0x74, 0x68, 0x2e,
	0x4b, 0x65, 0x79, 0x50, 0x61, 0x69, 0x72, 0x48, 0x00, 0x52, 0x07, 0x6b, 0x65, 0x79, 0x50, 0x61,
	0x69, 0x72, 0x1a, 0x92, 0x01, 0x0a, 0x07, 0x4b, 0x65, 0x79, 0x50, 0x61, 0x69, 0x72, 0x12, 0x40,
	...
	0xfa, 0x42, 0x05, 0x8a, 0x01, 0x02, 0x10, 0x01, 0x52, 0x06, 0x70, 0x75, 0x62, 0x4b, 0x65, 0x79,
	0x12, 0x45, 0x0a, 0x09, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x66, 0x6c, 0x69, 0x70, 0x63, 0x61, 0x73, 0x68, 0x2e, 0x63,
	...
	,
	...
	,
	...
	0x61, 0x2d, 0x7a, 0x41, 0x2d, 0x5a, 0x5d, 0x7b, 0x32, 0x2c, 0x7d, 0x24, 0x52, 0x05, 0x76, 0x61,
	0x6c, 0x75, 0x65, 0x22, 0xd0, 0x01, 0x0a, 0x13, 0x43, 0x72, 0x79, 0x70, 0x74, 0x6f, 0x50, 0x61,
	0x79, 0x6d, 0x65, 0x6e, 0x74, 0x41, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x2f, 0x0a, 0x08, 0x63,
	...
	,
	...
	,
	...
	0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x05, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x22, 0x1a, 0x0a,
	0x05, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x07, 0x0a, 0x03, 0x41, 0x53, 0x43, 0x10, 0x00, 0x12,
	0x08, 0x0a, 0x04, 0x44, 0x45, 0x53, 0x43, 0x10, 0x01, 0x22, 0x69, 0x0a, 0x07, 0x52, 0x65, 0x71,
	...
	0x62, 0x6f, 0x64, 0x79, 0x22, 0x92, 0x01, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	0x65, 0x12, 0x3b, 0x0a, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x0e, 0x32, 0x23, 0x2e, 0x66, 0x6c, 0x69, 0x70, 0x63, 0x61, 0x73, 0x68, 0x2e, 0x63, 0x6f, 0x6d,
	...
	,
	...
	0x5d, 0x7b, 0x33, 0x2c, 0x34, 0x7d, 0x24, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x33,
	0x0a, 0x05, 0x43, 0x6f, 0x6c, 0x6f, 0x72, 0x12, 0x2a, 0x0a, 0x03, 0x68, 0x65, 0x78, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x42, 0x18, 0xfa, 0x42, 0x15, 0x72, 0x13, 0x32, 0x11, 0x5e, 0x23, 0x5b,
	0x30, 0x2d, 0x39, 0x61, 0x2d, 0x66, 0x41, 0x2d, 0x46, 0x5d, 0x7b, 0x36, 0x7d, 0x24, 0x52, 0x03,
	0x68, 0x65, 0x78, 0x22, 0xfa, 0x01, 0x0a, 0x0c, 0x53, 0x75, 0x62, 0x73, 0x74, 0x69, 0x74, 0x75,
	...
	,
	...
	0x6f, 0x6e, 0x2e, 0x76, 0x31, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x49, 0x64, 0x48, 0x00, 0x52, 0x13,
	0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x54, 0x6f, 0x44, 0x69, 0x73, 0x70, 0x6c, 0x61, 0x79, 0x4e,
	0x61, 0x6d, 0x65, 0x42, 0x0b, 0x0a, 0x04, 0x6b, 0x69, 0x6e, 0x64, 0x12, 0x03, 0xf8, 0x42, 0x01,
	...
	0x2e, 0x66, 0x6c, 0x69, 0x70, 0x63, 0x61, 0x73, 0x68, 0x2e, 0x67, 0x65, 0x6e, 0x2e, 0x63, 0x6f,
	0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x76, 0x31, 0x5a, 0x4f, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
...
var file_common_v1_common_proto_goTypes = []any{
	...
	(*Hash)(nil),                // 5: flipcash.common.v1.Hash
	(*Auth)(nil),                // 6: flipcash.common.v1.Auth
	(*UserId)(nil),              // 7: flipcash.common.v1.UserId
	(*Username)(nil),            // 8: flipcash.common.v1.Username
	(*ChatId)(nil),              // 9: flipcash.common.v1.ChatId
	(*IntentId)(nil),            // 10: flipcash.common.v1.IntentId
	(*AppInstallId)(nil),        // 11: flipcash.common.v1.AppInstallId
	(*PhoneNumber)(nil),         // 12: flipcash.common.v1.PhoneNumber
	(*EmailAddress)(nil),        // 13: flipcash.common.v1.EmailAddress
	(*CryptoPaymentAmount)(nil), // 14: flipcash.common.v1.CryptoPaymentAmount
	(*FiatPaymentAmount)(nil),   // 15: flipcash.common.v1.FiatPaymentAmount
	(*PagingToken)(nil),         // 16: flipcash.common.v1.PagingToken
	(*QueryOptions)(nil),        // 17: flipcash.common.v1.QueryOptions
	(*Request)(nil),             // 18: flipcash.common.v1.Request
	(*Response)(nil),            // 19: flipcash.common.v1.Response
	(*CountryCode)(nil),         // 20: flipcash.common.v1.CountryCode
	(*Locale)(nil),              // 21: flipcash.common.v1.Locale
	(*Region)(nil),              // 22: flipcash.common.v1.Region
	(*Color)(nil),               // 23: flipcash.common.v1.Color
	(*Substitution)(nil),        // 24: flipcash.common.v1.Substitution
	(*Auth_KeyPair)(nil),        // 25: flipcash.common.v1.Auth.KeyPair
}
var file_common_v1_common_proto_depIdxs = []int32{
	25, // 0: flipcash.common.v1.Auth.key_pair:type_name -> flipcash.common.v1.Auth.KeyPair
	3,  // 1: flipcash.common.v1.CryptoPaymentAmount.mint:type_name -> flipcash.common.v1.PublicKey
	16, // 2: flipcash.common.v1.QueryOptions.paging_token:type_name -> flipcash.common.v1.PagingToken
	...
	12, // 5: flipcash.common.v1.Substitution.phone_number_to_contact_name:type_name -> flipcash.common.v1.PhoneNumber
	7,  // 6: flipcash.common.v1.Substitution.user_id_to_display_name:type_name -> flipcash.common.v1.UserId
	3,  // 7: flipcash.common.v1.Auth.KeyPair.pub_key:type_name -> flipcash.common.v1.PublicKey
	4,  // 8: flipcash.common.v1.Auth.KeyPair.signature:type_name -> flipcash.common.v1.Signature
...
func file_common_v1_common_proto_init() {
	...
	file_common_v1_common_proto_msgTypes[21].OneofWrappers = []any{
		(*Substitution_PhoneNumberToContactName)(nil),
		(*Substitution_UserIdToDisplayName)(nil),
	}
	type x struct{}
