...
func (m *Username) validate(all bool) error {
	...
	if !_Username_Value_Pattern.MatchString(m.GetValue()) {
		err := UsernameValidationError{
			field:  "Value",
			reason: "value does not match regex pattern \"^[a-z0-9_]{2,15}$\"",
		}
		if !all {
			return err
		}
...
var _Username_Value_Pattern = regexp.MustCompile("^[a-z0-9_]{2,15}$")
...
func (m *Substitution) validate(all bool) error {
	...
	oneofKindPresent := false
	switch v := m.Kind.(type) {
	case *Substitution_PhoneNumberToContactName:
		if v == nil {
			err := SubstitutionValidationError{
				field:  "Kind",
				reason: "oneof value cannot be a typed-nil",
		...
		if all {
			switch v := interface{}(m.GetPhoneNumberToContactName()).(type) {
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, SubstitutionValidationError{
						field:  "PhoneNumberToContactName",
						reason: "embedded message failed validation",
						cause:  err,
					})
				}
		...
		} else if v, ok := interface{}(m.GetPhoneNumberToContactName()).(interface{ Validate() error }); ok {
			if err := v.Validate(); err != nil {
	...
	case *Substitution_UserIdToDisplayName:
		if v == nil {
			err := SubstitutionValidationError{
				field:  "Kind",
				reason: "oneof value cannot be a typed-nil",
		...
		if all {
			switch v := interface{}(m.GetUserIdToDisplayName()).(type) {
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, SubstitutionValidationError{
						field:  "UserIdToDisplayName",
						reason: "embedded message failed validation",
						cause:  err,
					})
				}
		...
		} else if v, ok := interface{}(m.GetUserIdToDisplayName()).(interface{ Validate() error }); ok {
			if err := v.Validate(); err != nil {
				return SubstitutionValidationError{
					field:  "UserIdToDisplayName",
					reason: "embedded message failed validation",
